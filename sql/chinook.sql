...
-- Load data
LOAD DATA FROM FILE '/home/irisowner/dev/data/Artist.csv' INTO "chinook"."Artist" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/Album.csv' INTO "chinook"."Album" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/Employee.csv' INTO "chinook"."Employee" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/Customer.csv' INTO "chinook"."Customer" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/Genre.csv' INTO "chinook"."Genre" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/Invoice.csv' INTO "chinook"."Invoice" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/MediaType.csv' INTO "chinook"."MediaType" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/Track.csv' INTO "chinook"."Track" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/InvoiceLine.csv' INTO "chinook"."InvoiceLine" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/Playlist.csv' INTO "chinook"."Playlist" USING {"from":{"file":{"header":true}}}
GO
LOAD DATA FROM FILE '/home/irisowner/dev/data/PlaylistTrack.csv' INTO "chinook"."PlaylistTrack" USING {"from":{"file":{"header":true}}}
GO